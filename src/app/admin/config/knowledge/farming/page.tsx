...
const defaultItem: IKnowledge = {
    ...
    name: '',
    tree_type: null,
    category: KnowledgeTypes.farming,
    media: {
        url: '',
        media_type: 'image'
    }
...
export default function Farming() {
    ...
    const {error, refetch, loading, data} = useFetchKnowledge(KnowledgeTypes.farming);
    const {
        mutate,
        loading: loadingAdd,
        isSuccess,
        isError,
        error: errorUpdate
    } = useAddKnowledge(KnowledgeTypes.farming);
    const {mutate: updateKnowledge, loading: loadingUpdate} = useUpdateKnowledge(KnowledgeTypes.farming);
    ...
    return <>
        <div className="flex items-center justify-between space-y-2 flex-wrap">
            <h2 className="text-3xl font-bold tracking-tight">Kỹ thuật canh tác</h2>
            <div
