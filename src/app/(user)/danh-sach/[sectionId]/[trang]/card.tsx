...
export default function (
    ...
    >
        <div
            className={cn(imageClassname, `rounded-md 2xl:h-[180px] xl:h-[200px] md:h-[150px] border border-gray-300`)}>
            <Image
        ...
        <div className={'flex flex-col gap-0.5 flex-1 box-border pl-1'}>
            ...
            <h1 className={'text-base font-medium text-green-700 line-clamp-4'}>{item.title}</h1>
            {
                item.text ? <div
