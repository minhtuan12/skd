...
const InteractiveMap = dynamic(() => import("@/app/(user)/ban-do/ban-do-dat/interactive-map"), { ssr: false });
const MapList = dynamic(() => import("@/app/(user)/ban-do/ban-do-dat/map-list"), { ssr: false });
